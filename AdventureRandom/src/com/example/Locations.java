...
public class Locations implements Map<Integer, Location> {
    ...
    static {
        try{
            ...
            int numLoactions = ra.readInt();
            int locationStartPoint = ra.readInt();

            while(ra.getFilePointer()<locationStartPoint){
                int loactionID = ra.readInt();
                int loactionStart = ra.readInt();
                int loactionLength = ra.readInt();

                IndexRecord record = new IndexRecord(loactionStart,loactionLength);
            }

        }catch (IOException e){
            System.out.println("IOException Static Init " + e.getMessage());
        }
